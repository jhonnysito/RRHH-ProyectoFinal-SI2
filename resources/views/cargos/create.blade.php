<x-app-layout>
    <x-slot name="title">Crear Cargo</x-slot>

    <h1 class="text-2xl font-bold mb-6">➕ Crear Cargo</h1>

    <form action="{{ route('cargos.store') }}" method="POST" class="bg-white p-6 rounded shadow-md space-y-4">
        @csrf
