...
<body class="bg-gray-100">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16 items-center">
                ...
                <nav class="space-x-4 hidden md:flex">
                    <a href="{{ route('login') }}" class="text-gray-800 hover:text-blue-600 font-medium">Iniciar sesión</a>
    ...
    <main class="flex flex-col items-center justify-center text-center mt-16 px-4">
        ...
        <p class="text-gray-600 text-lg md:text-xl mb-8 max-w-2xl">Gestiona empleados, roles, permisos y mucho más de forma sencilla y eficiente.</p>
        <a href="{{ route('login') }}" class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-6 rounded-lg transition">Iniciar sesión</a>
    </main>
