<x-app-layout>
    ...
    <div class="min-h-screen bg-gray-100">
        <div class="max-w-7xl mx-auto py-6 px-4">
            ...
            {{-- Filtros --}}
            <form method="GET" action="{{ route('empleados.index') }}" class="bg-white shadow rounded-lg p-4 mb-6">
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                    <div>
                        <label class="block text-sm font-medium text-gray-700">Departamento</label>
                        <select name="departamento" class="w-full mt-1 border-gray-300 rounded-md">
                            <option value="">Seleccione departamento</option>
                            @foreach($departamentos as $depto)
                                <option value="{{ $depto->id }}" {{ $departamento == $depto->id ? 'selected' : '' }}>
                                    {{ $depto->nombre }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div>
                        ...
                        <select name="cargo" class="w-full mt-1 border-gray-300 rounded-md">
                            <option value="">Seleccione cargo</option>
                            @foreach($cargos as $c)
                                <option value="{{ $c->id }}" {{ $cargo == $c->id ? 'selected' : '' }}>
                                    {{ $c->nombre }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div>
                        ...
                        <select name="estado" class="w-full mt-1 border-gray-300 rounded-md">
